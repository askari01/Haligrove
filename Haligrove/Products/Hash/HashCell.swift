...
class HashCell: FoldingCell, NSCacheDelegate {
    ...
    func setupFoldingCell(product: Product) {
        ...
        hashNameLabel.font = UIFont.boldSystemFont(ofSize: 23)
    ...
    func createForegroundView() -> RotatedView {
        ...
        hashNameLabel.anchor(top: imageContainer.topAnchor, right: foregroundView.rightAnchor, bottom: nil, left: imageContainer.rightAnchor, paddingTop: 0, paddingRight: 0, paddingBottom: 0, paddingLeft: 8, width: 0, height: 0)
        
        typeLabel.anchor(top: hashNameLabel.bottomAnchor, right: nil, bottom: nil, left: imageContainer.rightAnchor, paddingTop: 0, paddingRight: 0, paddingBottom: 0, paddingLeft: 8, width: 0, height: 0)
